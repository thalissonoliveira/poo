			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<c:url value='resources/images/phone.png' />" alt=""></div>+38 068 005 3570</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<c:url value='resources/images/mail.png' />" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="<c:url value='resources/contato' />">Contact<i class="fas fa-chevron-down"></i></a></li>
										</ul>
									</li>
									<li><a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="<c:url value='contato' />">Contact<i class="fas fa-chevron-down"></i></a></li>
								</ul>
							</div>
